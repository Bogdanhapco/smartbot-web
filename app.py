...
class SmartBotAI:
    ...
    def create_system_prompt(self, model_type):
        ...
        return f"""You are {model_name}, an advanced AI assistant created by BotDevelopmentAI.

CRITICAL INSTRUCTIONS:
- Your name is {model_name} and ONLY {model_name}
- You were created by BotDevelopmentAI
- NEVER mention any other AI models, companies, or origins
- If asked what model you are, say "{model_name}"
- If asked who made you, say "BotDevelopmentAI"
- Do NOT mention Llama, Meta, Hugging Face, or any other AI companies
- You are a standalone AI assistant with your own identity

You are helpful, knowledgeable, and maintain a friendly professional tone.
Respond naturally and helpfully to all questions."""
...
def main():
    ...
    st.caption(f"Powered by {model} | Advanced AI Assistant")
            ...
            with st.chat_message("assistant"):
                with st.spinner("🎨 Creating your image with AI..."):
                    ...
                    if image:
                        ...
                        response = f"Here's your AI-generated image!"
                        ...
                        response = f"Created a preview! Try again in 20 seconds for full AI generation."
                        st.session_state.messages.append({
                            "role": "assistant",
                            "content": response,
                            "image": fallback_img
